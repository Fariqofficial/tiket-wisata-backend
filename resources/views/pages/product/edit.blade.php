                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="selectgroup selectgroup-pills">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="diterbitkan" class="selectgroup-input"
                                            {{ $product->status == 'diterbitkan' ? 'checked' : '' }}>
                                        <span class="selectgroup-button">Diterbitkan</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="diarsipkan" class="selectgroup-input"
                                            {{ $product->status == 'diarsipkan' ? 'checked' : '' }}>
                                        <span class="selectgroup-button">Diarsipkan</span>
                                    </label>
                                </div>
                            </div>
